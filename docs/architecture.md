...
Примечание по `freeze_hours` (время фиксации):
- За `freeze_hours` до старта блокируются: запись, отмена активной записи, выход из очереди и отмена тренировки администратором.
